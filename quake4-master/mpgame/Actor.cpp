...
void idActor::Damage( idEntity *inflictor, idEntity *attacker, const idVec3 &dir, 
	...
	//aal Nail Gun DOT
	if(static_cast<idPlayer*>(attacker)->GetCurrentWeapon()==7|| static_cast<idPlayer*>(attacker)->GetCurrentWeapon()==1)
	{
		
		this->Event_DamageOverTimeEffect(10,5,damageDefName);	
	}					  
