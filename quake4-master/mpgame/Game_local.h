...
public:
	...
	int						enemiesCanSpawn;		//aal will be set to allow players to spawn
	int						activePlayers;          //aal number of players alive
	idEntity*				allowSpawn[MAX_CLIENTS];//aal enties in front will spawn if a player
